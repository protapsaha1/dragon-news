...
const RightNavbar = () => {
    return (
        <div>
            ...
            <Button className='mb-2' variant="outline-secondary"><FaGoogle /> Login with Google</Button><br />
            <Button className='mb-2' variant="outline-dark"><FaGithub /> Login with Github</Button><br />
            <Button className='mb-2' variant="outline-info"><FaFacebook /> Login with Facebook</Button>
            <div>
            ...
            <div className='position-relative'>
                ...
                <Button variant="danger" className='position-absolute bottom-0 start-0'>Learn More</Button>
            </div>
        </div>
